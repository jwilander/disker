...
Boundary::Boundary(PhysicsScreen *scene, float width, float height)
{
    ...
    scene->addPhysicsChild(bottomWall, PhysicsScreenEntity::ENTITY_RECT, true, 0.1, 1, 0.5, false, false, -1);
    ...
    scene->addPhysicsChild(leftWall, PhysicsScreenEntity::ENTITY_RECT, true, 0.1, 1, 0.5, false, false, -1);
    ...
    scene->addPhysicsChild(rightWall, PhysicsScreenEntity::ENTITY_RECT, true, 0.1, 1, 0.5, false, false, -1);
    ...
    scene->addPhysicsChild(topWall, PhysicsScreenEntity::ENTITY_RECT, true, 0.1, 1, 0.5, false, false, -1);
}
